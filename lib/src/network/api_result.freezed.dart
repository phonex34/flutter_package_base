...
// ignore: unused_element
  Invalidate<T> invalidate<T>({dynamic error}) {
    return Invalidate<T>(
      error: error,
    );
  }
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object>({
    ...
    TResult invalidate(dynamic error),
  });
  @optionalTypeArgs
  ...
  TResult map<TResult extends Object>({
    ...
    @required TResult invalidate(Invalidate<T> value),
  });
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object>({
    TResult success(Success<T> value),
    TResult failure(Failure<T> value),
    TResult invalidate(Invalidate<T> value),
    @required TResult orElse(),
  });
}
...
class _$Success<T> with DiagnosticableTreeMixin implements Success<T> {
  ...
  TResult when<TResult extends Object>({
    @required TResult success(T data),
    @required TResult failure(NetworkExceptions error),
    @required TResult invalidate(dynamic error),
  }) {
    assert(success != null);
    assert(failure != null);
    return success(data);
...
/// @nodoc
abstract class $InvalidateCopyWith<T, $Res> {
  factory $InvalidateCopyWith(
          Invalidate<T> value, $Res Function(Invalidate<T>) then) =
      _$InvalidateCopyWithImpl<T, $Res>;
  $Res call({dynamic error});
}

/// @nodoc
class _$InvalidateCopyWithImpl<T, $Res> extends _$ApiResultCopyWithImpl<T, $Res>
    implements $InvalidateCopyWith<T, $Res> {
  _$InvalidateCopyWithImpl(
      Invalidate<T> _value, $Res Function(Invalidate<T>) _then)
      : super(_value, (v) => _then(v as Invalidate<T>));

  @override
  Invalidate<T> get _value => super._value as Invalidate<T>;

  @override
  $Res call({
    Object error = freezed,
  }) {
    return _then(Invalidate<T>(
...
/// @nodoc
class _$Invalidate<T> with DiagnosticableTreeMixin implements Invalidate<T> {
  const _$Invalidate({this.error});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ApiResult<$T>.invalidate(error: $error)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ApiResult<$T>.invalidate'))
      ..add(DiagnosticsProperty('error', error));
  }
  ...
  @JsonKey(ignore: true)
  @override
  $InvalidateCopyWith<T, Invalidate<T>> get copyWith =>
      _$InvalidateCopyWithImpl<T, Invalidate<T>>(this, _$identity);
...
abstract class Invalidate<T> implements ApiResult<T> {
  const factory Invalidate({dynamic error}) = _$Invalidate<T>;
